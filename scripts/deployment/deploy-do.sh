...
echo "   - Copy scripts/deployment/setup-server-supabase.sh to the server"
echo "   - Or run the setup commands manually (see docs/deployment/DIGITALOCEAN_DEPLOYMENT.md)"
echo ""
