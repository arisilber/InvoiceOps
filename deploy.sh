...
echo "   Your site is currently using HTTP (not secure)."
echo "   To set up HTTPS/SSL, see: docs/deployment/SSL_SETUP.md"
echo "   Quick setup: bash scripts/deployment/setup-ssl.sh your-domain.com your-email@example.com"
echo ""
